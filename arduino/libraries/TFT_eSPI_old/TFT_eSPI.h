...
extern int8_t global_cs;
extern int8_t global_reset;
extern int8_t global_dc;
extern int8_t global_sdi;
extern int8_t global_sck;
extern int8_t global_led;
extern int8_t global_sdo;
...
class TFT_eSPI : public Print { friend class TFT_eSprite; // Sprite class has access to protected members
 ...
 //--------------------------------------- public ------------------------------------//
 public:
  TFT_eSPI(int16_t _W = TFT_WIDTH, int16_t _H = TFT_HEIGHT, int8_t _cs=-1, int8_t reset=-1, int8_t dc=-1, int8_t sdi=-1, int8_t sck=-1, int8_t led=-1, int8_t sdo=-1);
