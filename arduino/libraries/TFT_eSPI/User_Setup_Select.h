...
struct TFT_config {
    int8_t cs           = TFT_CS; // TFT_CS is currently some number
    int8_t reset        = TFT_RST;
    int8_t dc           = TFT_DC;
    int8_t sdi          = TFT_MOSI;
    int8_t sck          = TFT_SCLK;
    int8_t led          = TFT_LED;
...
extern TFT_config globalConfig;

#define TFT_MISO    (globalConfig.sdo) // redefine to point at runtime value
#define TFT_MOSI    (globalConfig.sdi)
#define TFT_SCLK    (globalConfig.sck)
#define TFT_CS      (globalConfig.cs)
#define TFT_DC      (globalConfig.dc)
#define TFT_RST     (globalConfig.reset)
#define TFT_LED     (globalConfig.led)
#define TFT_MAD_COLOR_ORDER (globalConfig.colorOrder == TFT_RGB ? TFT_MAD_RGB : TFT_MAD_BGR)
